...
if st.session_state["chat_history"]:
    latest_role, latest_text = st.session_state["chat_history"][0]  # Get the latest message
    if latest_role == "You":
        st.write(f"**You:** {latest_text}")
    else:
        st.write(f"**Bot:** {latest_text}")
...
if submit_button and user_input:
    ...
    st.session_state["chat_history"].insert(1,("You", user_input))
    ...
    if bot_reply:
        ...
        st.session_state["chat_history"].insert(1,("Bot", bot_reply))
